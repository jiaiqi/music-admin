<template>
  <div>
    <!-- <el-row :gutter="20">
      <el-col :span="8">
        <div class="card kjfs">
          ...
          <ul>
            <li>
              <router-link to="/addArticleEditor" class="kjfs kjfs-bluee"
                ...
                ><span>发表文章</span></router-link
              >
            </li>
            <li>
              <router-link to="/dragTabe" class="kjfs kjfs-pinkk"
                ><span><i class="fa fa-hand-stop-o fa-2x"></i></span
                ><span>拖拽排序</span></router-link
              >
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              <router-link to="/navClassifies" class="kjfs kjfs-purplee"
                ><span><i class="fa el-icon-menu fa-2x"></i></span
                ><span>前台菜单</span></router-link
              >
            </li>
            <li>
      ...
      <!-- <el-col :span="8">
        <div class="card dbsx">
          <p class="title"><i class="fa fa-file-text-o"></i>数据展示</p>
          <ul>
            <li>
              <router-link to="#"
                ><span>歌曲数量</span><span class="num">66</span></router-link
              >
            </li>
            <li>
              <router-link to="#"
                ><span>分享总数</span><span class="num">66</span></router-link
              >
            </li>
          </ul>
          <ul>
            <li>
              <router-link to="#"
                ><span>用户数量</span><span class="num">66</span></router-link
              >
            </li>
            <li>
              <router-link to="#"
                ><span>评论总数</span><span class="num">66</span></router-link
              >
            </li>
          </ul>
        </div>
      ...
      <el-col :span="24">
        <div class="card bbxx">
          <p class="title"><i class="fa fa-server"></i>系统信息</p>
          <div class="table">
            <p><span class="tit">当前版本</span>v1.0.0</p>
            <p><span class="tit">前端</span>vue2.0全家桶 + element-ui</p>
            <p><span class="tit">后端</span>koa.js + egg.js + mysql </p>
            <p><span class="tit">主要特色</span>单页面 / 响应式 / 权限管理</p>
            <p>
              <!-- <span class="tit">获取渠道</span> -->
              <span class="gitbox">
                <!-- <a target="_blank" href="https://github.com/Jia/nodePlatform-eggjs"><el-button type="primary" icon="el-icon-download" size="small">github</el-button></a> -->
                <!-- <a target="_blank" href="https://gitee.com/Jia/nodePlatform-eggjs"><el-button type="primary" icon="el-icon-download" size="small">码云</el-button></a> -->
              </span>
            </p>
          </div>
        </div>
